...
function PanditsClient({ pandits = [], userId }) {
  ...
  // ✅ Polling - use prop instead of parsing cookie
  useEffect(() => {
    if (!userId) return;
  ...
  return (
    <>
      {/* ✅ Pass userId like CallExpertsSection */}
      <PanditsGrid
      ...
      {incomingCall && (
        <div className="fixed inset-0 z-50 bg-zinc-950 flex flex-col items-center justify-between px-6 py-16">
          <div className="text-center">
            ...
            <div className="w-32 h-32 rounded-full bg-emerald-800 flex items-center justify-center text-emerald-200 font-bold text-4xl mx-auto mb-6">
          ...
          <div className="flex gap-20">
            ...
            <button
              ...
              disabled={accepting}
              className="w-20 h-20 rounded-full bg-emerald-500 text-white"
            >
              {accepting ? "..." : "Accept"}
            </button>
          </div>
